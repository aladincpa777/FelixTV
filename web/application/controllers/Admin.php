...
class Admin extends CI_Controller {   
    ...
    function dashboard(){
        ...
        //$this->db->like('create_at', array('create_at' => date('Y-m-d')))->result_array(); 
        //$res = $this->db->get('analytics')->result_array();
        //$data['seo_today']    =  $this->db->like('create_at', date('Y-m-d'));
        //$ye_dy = date('Y-m-d', strtotime("-1 days"));

        //$after_date = $this->db->get('analytics')->like('create_at', date('Y-m-d'), 'after')->result_array();
        $data['seo_today']    =  $this->db->get('analytics')->result_array(); 
...
function videos($param1 = '', $param2 = ''){
    ...
    // users
    function manage_reports($param1 = '', $param2 = ''){
        if ($this->session->userdata('admin_is_login') != 1)
            redirect(base_url(), 'refresh');
            /* start menu active/inactive section*/
            $this->session->unset_userdata('active_menu');
        ...
        if ($param1 == 'delete') {
            $response = array();
            $report_id           = $this->input->post('wish_list');
            $this->db->where('wish_list_id', $report_id);
            $run=$this->db->delete('wish_list');
            if($run){
                $response['status']  = 'success';
                $response['message'] = 'Nahlášení smazáno ...';
            }
            else {
                $response['status']  = 'error';
                $response['message'] = 'Chyba, nelze odstranit ...';
            }
                echo json_encode($response);
        }
        
            $data['page_name']      = 'report_manage';
            $data['page_title']     = 'Reports Management';
            $data['reports']    = $this->db->get_where('wish_list',array('wish_list_type' => 'rt'))->result_array(); 
            $this->load->view('admin/index', $data);
    }
    ...
    function post_rating( $rate , $video_id){
		...
		public function movie_scrapper() {
			$message            =   '';
            //$list               =   trim("Zoufalá matka - A Mother's Sacrifice - 5ca9s13791c30f114115 - [cs],Slůně v nesnázích - Zoo - 5ca9s16629c32d738128 - [cs],Amityville: Počátek - The Amityville Murders - 5cads73223c306115129 - [cs],Íránská divočina - Iran's Wild Side - 5cabs03219c326116611 - [cs],Husar na střeše - Le Hussard sur le toit - 5ca7s19666c33d538119 - [cs],O Ječmínkovi - O Ječmínkovi - 5c40s23151c21a115555 - [cs],Zuřivý reportér - Zuřivý reportér - 5c36s34806c2c1111689 - [cs],Čekání na déšť - Čekání na déšť - 5c4es83212c210118151 - [cs],Turistův průvodce po Marsu - Mars: A Traveller's Guide - 5c4ds03209c21f116693 - [cs],Alenka v zemi zázraků - Alenka v zemi zázraků - 5c4as19646c226538119 - [cs],Když draka bolí hlava - Když draka bolí hlava - 5c45s18456c219636217 - [cs],Vítr ve vlasech - Nessuno mi pettina bene come il vento - 7975866acaddc16d1c80 - [cs],Čarovné střevíce - Die Galoschen des Glücks - 5c06s15712c1fa932092 - [cs],Řeka do nenávratna - River of No Return - 5c12s83219c101118141 - [cs],Otevřené oči - Chasing Sleep - 5c0as99141c1b6197191 - [cs],Despite the Falling Snow - Despite the Falling Snow - 5bbcs05912cf94219149 - [en],Ve službách krále - Le miracle des loups - 5bbds18414cf75636233 - [cs],Batman vs. Two-Face - Batman vs. Two-Face - 5bb5s03201cf8a116655 - [en],Mutafukaz - Mutafukaz - 5bbbs14413cf25218741 - [en],Scream for Me Sarajevo - Scream for Me Sarajevo - 5bb2s19601cf90538111 - [en],Prooi - Prey - 5bb0s16633cf79839086 - [fr],Asterix a tajemství kouzelného lektvaru - Astérix: Le
en - Finding Steve McQueen - 5b61s23131c6a1115569 - [en],Acrimony - Acrimony - 5b6ds13771c686114105 - [en],Amsusalin - Dark Figure of Crime - e58bbbb0be23d86ac5f9 - [ko],Arctic: Ledové peklo - Arctic - 5b6cs16518c6a8738911 - [en],A Christmas Prince: The Royal Wedding - A Christmas Prince: The Royal Wedding - 5b0es73201c5c6115105 - [en],Vysněná zem - Huan tu - 5b04s99135c5a4197115 - [en],The Silence - The Silence - 5b07s19530c5fb538912 - [en],¿A quién te llevarías a una isla desierta? - Who Would You Take to a Deserted Island? - 5b03s18449c5e5636055 - [es],Chlapec který se stane králem - The Kid Who Would Be King - 5b05s34883c59a111571 - [encs],The Russian Bride - The Russian Bride - 5b0bs83211c5e8118135 - [en],The Hard Way - The Hard Way - 5bbes03282c3d6116567 - [en],The Last Laugh - The Last Laugh - 5bb9s16532c3ca839857 - [en],The Perfect Date - The Perfect Date - 5bbas19518c3e8538911 - [en],Fyre - Fyre - 5bb1s23134c3d5115523 - [en],High Flying Bird - High Flying Bird - 5bb5s14413c38f218728 - [en],Paddleton - Paddleton - 5bb3s15600c3d2932864 - [en],Karélie: Ruský prales - Wildes Karelien - Land der Braunbären und Singschwäne - 5b87s03288c284116552 - [cs],Zmrzlý na kost - Stiff - 5b85s16552c289738887 - [cs],Sardinky aneb Život jedné rodinky - Sardinky aneb Život jedné rodinky - 5b8as23139c274115508 - [cs],Neprůstřelný plán - Foolproof - 5b8fs14411c220218726 - [cs],Já truchlivý Bůh - Já truchlivý Bůh - 5b8cs15699c271932770 - [cs],Unavená smrt - Der müde Tod - bb4c144495cd131f5d57 - [cs],Kostarika země harmonie - Costa Rica l'harmonie des sens - 5b42s83215c1e3118121 - [cs],Vesmírný závod 21. století - The 21st Century Race for Space - 5b4as14410c184218721 - [cs],Paleta lásky - Paleta lásky - 5b4bs99121c191197153 - [cs],Před ranními červánky - Vor der Morgenröte - 5b40s16549c1e9738886 - [cs],Kod apokalipsisa - Kod apokalipsisa - 5b4es19571c1e4538831 - [sk],Prahou s panem Tau a Arabelou - Prahou s panem Tau a Arabelou - 5b4as18385c1d1636918 - [cs],Kouzlo pohybu pod rentgenem - X-Ray Run - Das Geheimnis des Laufens - 5b45s23129c1d5115599 - [cs],Orel skalní: Král hor - Kráľ nebies – Orol skalný - 5b4cs34887c18e111511 - [cs],The Limit of Sleeping Beauty - The Limit of Sleeping Beauty - 5ae9s63324cf3c114577 - [en],Kornélius - Vyjící mlynář - Cornélius le meunier hurlant - 5ae3s18366cf41636912 - [fr],Pepek - Pop Aye - 5aefs15644cf3f932714 - [en],Láska a cestování časem - Chronesthesia - 5aebs03283cf43116507 - [en],Unicorn Store - Unicorn Store - 5ae7s19552cf53538887 - [en],Heavy Trip - Hevi reissu - 5a79s18333ce3e636911 - [en]");//$this->input->post('movie_list'));
		...
		if(isset($data['Title'])){
                ...
                $imdb_data['stream']            = "http://www.streamuj.tv/video/".$explode_movie[2];
                $poster                         = $data['Poster'];
                if($type=='series'){
                    $imdb_data['is_tvseries']   = '0';                    
                }
