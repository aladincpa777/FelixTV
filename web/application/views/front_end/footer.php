        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="footer-about  " >
                    <img class="img-responsive" src="<?php echo base_url() ?>uploads/system_logo/logo.png" height="180" width="180" alt="Logo">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="sendus  ">
                    <div class="movie-heading"> <span>Odebírat</span>
                        <div class="disable-bottom-line"></div>
                    </div>
                    <div id="contact-form">
                        <div class="expMessage"></div>
                        <p class="text-light">Přihlaste se do našeho mailing listu a získejte informace o filmech,seriálech a aktualitách</p>
                            <input type="text" name="formInput[name]" id="name" class="form-control half-wdth-field pull-right" placeholder="Vaše jméno" required>
                            ...
                            <div id="error" style="display: none;"></div>
                                ...
                                <a class="btn btn-success" id="subscribe-btn"> Odebírat </a>
                            </div>
                    </div>
                </div>
            </div>
