        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12 text-right">
                <ul class="breadcrumb">
                    ...
                    <li class="">Můj-účet</li>
                    <li class="active">Shlédnout později</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="profiles-wrap">
                            ...
                            <ul>
                                ...
                                <li class="active">
                                    <a href="<?php echo base_url('my-account/watch-later'); ?>">
                                        <i class="fi ion-ios-clock-outline m-r-10"></i> Shlédnout později
                                    </a>
                                </li>
                                <li class="">
                    ...
                    <div class="pp-main">
                        <div class="ppm-head">
                            <div class="ppmh-title"><i class="fa fa-clock-o mr5"></i> Shlédnout později</div>
                        </div>
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            if(response.status =='success'){
                                swal("Povedlo se!", "Úspěšně odstraněno!", "success");
                                $(table_row).fadeOut(2000);
                            }else if(response.status =='login_error') {
                                swal('Chyba přihlášení', "Prosím přihlaš se pro odstranění", "error");
                                $(table_row).fadeOut(2000);
                            }else {
                                swal('Chyba!!', "Nepovedlo se odstranit..", "error");
                                $(table_row).fadeOut(2000);
                            }
