    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <h2 class="block-title text-center">Napište nám<br>
                    <small>Máte nějaké dotazy? Chcete spolupráci? Napište nám!</small>
                </h2>

                <div class="sendus">
                    <div class="movie-heading m-b-20"> <span>Pošlete Nám Zprávu</span>
                    ...
                    <div id="contact-form">
                        ...
                        <form class="custom-form" id="" method="post" action="<?php echo base_url().'contact_process'; ?>">
                            <input type="text" name="name" id="name" class="form-control half-wdth-field" placeholder="Jméno" >
                            <div id="name_error"></div>
                            <input type="text" name="email" id="email" class="form-control half-wdth-field pull-right" placeholder="Email" >
                            <div id="email_error"></div>
                            <textarea name="message" id="message" class="form-control" rows="4" placeholder="Zpráva"></textarea>
                            <div id="message_error"></div>
                            <input type="hidden" name="action" value="submitform">
                            <div>
                                <button type="submit" value="submit" id="submit-btn" class="btn btn-success"> <span class="btn-label"><i class="fi ion-paper-airplane"></i></span>Odeslat zprávu </button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xs-12">
                <address class="m-l-50 text-center">
                    ...
                    <p><strong>DMCA:&nbsp;</strong><a href="mailto:dmca@felixtv.cz">dmca@felixtv.cz</a></p>
