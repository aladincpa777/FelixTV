			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-4 col-xs-12 text-right">
					<ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url('tv-series');?>"></a>TV Seriály</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php if($total_rows > 24){ echo $links; } }else{ echo '<center><h3> Opps!! Nebyly nazelezeny žádné TV Seriály :(</h3></center>'; } ?>		
