			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-4 col-xs-12 text-right">
					<ul class="breadcrumb">
					    ...
					    <li class="active">Vyžádané filmy</li>
					</ul>
				</div>
			</div>
		</div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <div class="latest-movie-img-container">
                                    ...
                                    <div class="movie-title">
                                        ...
                                        <p class="movie-desc"> <span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $videos->runtime;?></span><span>&nbsp;&#47;</span> <span><?php echo $videos->total_view;?> sledované</span> </p>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
...
<?php if($total_rows > 24){ echo $links; } }else{ echo '<center><h3> Opps!! Žádný film nenalezen</h3></center>'; } ?>		
