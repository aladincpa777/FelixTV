			...
			<div class="row">
				<div class="col-md-9 col-sm-8 col-xs-12">
					<div class="page-title">
						<h1 class="text-uppercase">Film na základě roku: <?php echo $year; ?></h1>
					</div>
				</div>
                        ...
                        <div class="movie-container">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <div class="latest-movie-img-container">
                                    <div class="movie-img"> <img class="img-responsive" src="<?php echo $this->common_model->get_video_thumb_url($videos->videos_id); ?>" alt="<?php echo $videos->title;?>"> <a href="<?php if($videos->is_tvseries =='1'){ echo base_url('tv-series/watch/'.$videos->slug.'.html');}else{  echo base_url('watch/'.$videos->slug.'.html');}?>" class="ico-play ico-play-sm"> <img class="img-responsive play-svg svg" src="<?php echo base_url(); ?>assets/front_end/images/play-button.svg" alt="play" onerror="this.src='<?php echo base_url(); ?>assets/front_end/images/play-button.png'"> </a>
...
<?php }
	...
	echo "<h2 class='text-center text-capitalize'>Žádný film nebyl nalezen na rok ".$year;
	} ?>
	</div>
