...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
      <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="FelixTV" height="40">        
      </div>
      <div class="login-box">
        <form class="login-form" id="signup_form">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>ZAREGISTROVAT SE</h3>
          ...
          <div class="form-group">
            <div class="utility">
              <p class="semibold-text mb-0"><a href="<?php echo base_url('login'); ?>">Už máte účet ?</a></p>
            </div>
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" id="btn-login">ZAREGISTROVAT SE <i class="fa fa-sign-in"></i></button>
          </div>
        </form>
      </div>
    </section>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (signup_status == "success") {                      
                        Command: toastr["success"]("Registrace proběhla v pořádku", "Success");                        
                        setTimeout(' window.location.href = "' + redirect + '"; ', 2000);
                    }
                    else if (signup_status == "user_exist") {                      
                        Command: toastr["error"]("Uživ. jméno nebo Email byl již použit", "Opps");
                        $("#btn-login").html('<i class="fa fa-sign-in" aria-hidden="true"></i> &nbsp; REGISTRACE');
                    }
                    else if (signup_status == "empty_input") {                      
                        Command: toastr["error"]("Prosím zadej Email & Uživ. jméno správně", "Opps");
                        $("#btn-login").html('<i class="fa fa-sign-in" aria-hidden="true"></i> &nbsp; REGISTRACE');
                    }
                    else {
