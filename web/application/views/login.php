...
<html>
  ...
  <script src="assets/js/bootstrap.min.js"></script>
    ...
    <title><?php echo $system_name; ?> - Přihlásit se</title>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
      <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="FelixTV" height="90">        
      </div>
      <div class="login-box">
        <form class="login-form" id="login_form">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>PŘIHLÁŠENÍ</h3>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="username" placeholder="Uživatelské jméno" autofocus>
          </div>
          <div class="form-group">
            <label class="control-label">HESLO</label>
            <input class="form-control" type="password" id="password" placeholder="Heslo">
          </div>
          <div id="error"></div>
          ...
          <div class="form-group">
            <div class="utility">
              <div class="animated-checkbox">
                ...
                <p class="semibold-text mb-0"><a href="<?php echo base_url('user/signup'); ?>">Registrace</a></p>
                </label>
              </div>
              <p class="semibold-text mb-0"><a data-toggle="flip">Zapomenuté heslo ?</a></p>
            </div>
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" id="btn-login">PŘIHLÁSIT SE <i class="fa fa-sign-in fa-lg"></i></button>
          </div>
        </form>
        <form class="forget-form" method="post" action="<?php echo base_url().'user/forget_password/do_reset' ?>">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>Zapomenuté heslo ?</h3>
          <div class="form-group">
            <label class="control-label">EMAIL</label>
            <input class="form-control" type="text" name="email" value="<?php if(isset($email)){ echo $email;} ?>" placeholder="Email">
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block">RESETOVAT<i class="fa fa-unlock fa-lg"></i></button>
          </div>
          <div class="form-group mt-20">
            <p class="semibold-text mb-0"><a data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Zpět na Login</a></p>
          </div>
        </form>
      </div>
    </section>
        ...
        $("#login_form").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (login == "success") {
                        Command: toastr["success"]("Přihlášení proběhlo v pořádku..", "Success")
                        toastr.options = {
                            "closeButton": false,
                            "debug": false,
                            "newestOnTop": false,
                        ...
                        $("#error").fadeIn(1000, function() {
                            Command: toastr["warning"]("Uživatel nebo Heslo je špatně..", "Opps")
                            toastr.options = {
                                "closeButton": false,
                                "debug": false,
                                "newestOnTop": false,
