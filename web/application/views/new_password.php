    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <input type="hidden" name="token" value="<?php if(isset($token)){ echo $token;} ?>">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>ULOŽIT NOVÉ HESLO</h3>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="password" id="password" placeholder="Nové heslo" autofocus>
          </div>
          <div class="form-group">
            <label class="control-label">POTVRDIT NOVÉ HESLO</label>
            <input class="form-control" type="text" name="password2" id="password2" placeholder="Potvrdit nové heslo">
          </div>
          <div id="error"></div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" id="btn-login">Uložit <i class="fa fa-floppy-o"></i></button>
          </div>
        </form>
      </div>
    </section>
