  ...
  <div class="col-md-12">
   ...
   <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('tv-series/watch/').$slug; ?>" target="_blank"> <span class="btn-label"><i class="fa fa-eye"></i></span>Preview</a>
      ...
      <div class="panel panel-border panel-primary">
        ...
        <label>
          <input type="radio" name="radio-input"  id="link-active" checked><span class="label-text">Youtube, Google..</span>
        </label>
      </div>

        <!-- <div id="upload_section" style="display: none;" >  ** ADDED ** 
          ...
          <div id="link_section" >
            ...
            <div>
              <font color="orange" size="5" font-weight: bold>[</font><input type="checkbox" id="hd" name="hd" value="1">
              <label for="hd">HD?</label> <img src="<?php echo base_url();?>assets/front_end/images/hd.png"><font color="orange" size="5" font-weight: bold>]</font>

              <font color="orange" size="5" font-weight: bold>[</font><input type="checkbox" id="cze_lang" name="cze_lang" value="1">
              <label for="cze_lang">cze_lang?</label> <img src="<?php echo base_url();?>assets/front_end/images/cs.png"><font color="orange" size="5" font-weight: bold>]</font>

              <font color="orange" size="5" font-weight: bold>[</font><input type="checkbox" id="cze_sub" name="cze_sub" value="1">
              <label for="cze_sub">cze_sub?</label> <img src="<?php echo base_url();?>assets/front_end/images/cs-cc.png"> + <img src="<?php echo base_url();?>assets/front_end/images/en.png"> <font color="orange" size="5" font-weight: bold>]</font>
          </div>
            <div class="form-group" id="_source1">
              <label class="control-label" >URL</label>&nbsp;&nbsp;<input id="video_url" type="url" value="http://188981.w81.wedos.ws/Movies_Storage/" name="embed_link[]" class="form-control" placeholder="http://server-2.com/movies/titalic.mp4" required=""><br>
...
<div class="row"><div class="col-md-12">
    <div class="panel panel-border panel-primary">
          ...
          <table class="table table-bordered" id="video-list">
            <?php $episodes = $this->db->order_by('real_episode_id', 'ASC')->get_where('episodes', array('videos_id'=> $param1,'seasons_id'=>$param2))->result_array();
      ...
      $("#link-active").click(function(){
       ...
       $("#add-link").click(function(){
        ...
        var  seasons_id  = "<?php echo $param2; ?>";
         var remembered_hd = document.getElementById('hd');
            if (remembered_hd.checked){
            var  hd = "1";
             }else{
        var  hd = "";
    }
         var remembered_cze_lang = document.getElementById('cze_lang');
            if (remembered_cze_lang.checked){
            var  cze_lang = "1";
             }else{
        var  cze_lang = "";
    }
    var remembered_cze_sub = document.getElementById('cze_sub');
            if (remembered_cze_sub.checked){
            var  cze_sub = "1";
             }else{
        var  cze_sub = "";
    }
        if (isUrl(url)==true && url !='' && type!='' && episodes_name !='') {
            $.ajax({
                ...
                data: "videos_id="+videos_id+"&type=" + type + "&url=" + url + "&episodes_name=" +episodes_name + "&seasons_id=" + seasons_id + "&cze_lang=" + cze_lang + "&hd=" + hd,
                dataType: 'json',
