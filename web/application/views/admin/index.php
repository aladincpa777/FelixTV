...
<body class="sidebar-mini fixed <?php //if(isset($page_name) && ($page_name=='videos_add' || $page_name=='videos_edit'|| $page_name=='videos_manage')){ echo 'sidebar-collapse';}  ?>">
    <div class="wrapper">
        <!-- Navbar-->
        <header class="main-header hidden-print"><a class="logo" href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="FelixTV" height="50" style="margin-top:-15px;"></a>
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="top-nav">
                        <!-- User Menu-->
                        <li><h4><?php echo date("d.m.Y h:m:s");?></h4></li>
    ...
    <footer class="footer text-right"> <?php echo date("Y"); ?> © <a href="http://felixtv.cz/"> FelixTV &amp; Movie Steaming</a> |
