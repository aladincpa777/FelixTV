    ...
    <div class="row">
        <div class="col-sm-12">
          ...
          if(isset($message) && $message !=''){
            echo $message;
            echo '<div class="alert alert-info"><strong>Note: </strong> Předhcozí scrapovaný film nebyl ještě publikovaný. Prosím publikujte ho ručně.</div>';
            } ?>
            </div>
        </div>
        <div class="col-lg-6 col-md-offset-3">
            <div class="panel panel-border panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Import Filmů</h3>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class=" control-label"><?php echo tr_wd('Titulek'); ?></label>
                    ...
                    <div class="form-group">
                      <label class="control-label"><?php echo tr_wd('Režisér'); ?></label>
                    ...
                    <div class="form-group">
                      <label class="control-label"><?php echo tr_wd('scénář'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?php echo tr_wd('země'); ?></label>
                    ...
                    <div class="form-group">
                      <label class="control-label"><?php echo tr_wd('žánr'); ?></label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (imdb_status == 'success') {
                        $('#result').html('<div class="alert alert-success alert-dismissable m-t-15"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Data byla importována.</div>');
                        $("#title").val(title);
                        //slug
